...
df_co2 = pd.read_excel(data_folder + 'EDGAR_CO2bio_m_1970_2023.xlsx', sheet_name='IPCC 2006')
print('Excel read.')
...
## check range!
co2cut= df_co2.iloc[9:49758, 8:21].reset_index(drop=True)
print('Dataframe cut.')
#print(co2cut.head())
...
co2cut.replace('###', np.nan, inplace=True)
...
for i in range(8,21):
    co2cut.rename(columns={'Unnamed: {i}': month[i-8]}, inplace=True)
