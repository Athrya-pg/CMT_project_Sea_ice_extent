...
df_nhcut = pd.read_csv(output_folder + 'sea_ice_nh.csv') # , names=['NH_Extent', 'Year']
df_shcut = pd.read_csv(output_folder + 'sea_ice_sh.csv') # names=['SH_Extent', 'Year']
...
merged_sh['log_CO2'] = np.log(merged_sh['CO2'])
...
# ax3.plot(merged_nh['Year'], merged_nh['NH_Extent'], color='blue', label='NH Sea Ice Extent')
# ax3.set_xlabel('Year')
# ax3.set_ylabel('NH Sea Ice Extent', color='blue')
# ax3.tick_params(axis='y', labelcolor='blue')

# ax3_twin = ax3.twinx()
# ax3_twin.plot(merged_nh['Year'], merged_nh['CO2'], color='red', label='CO2')
# ax3_twin.set_ylabel('CO2', color='red')
# ax3_twin.tick_params(axis='y', labelcolor='red')

# ax3.set_title('Northern Hemisphere\'s Sea Ice Extent and CO2 Emissions Over Time')
# ax3.legend(loc='upper left')
# ax3_twin.legend(loc='upper right')

# # Plot log-transformed SH Sea Ice Extent vs CO2 Mass
# ax4.plot(merged_sh['Year'], merged_sh['SH_Extent'], color='green', label='SH Sea Ice Extent')
# ax4.set_xlabel('Year')
# ax4.set_ylabel('SH Sea Ice Extent', color='green')
# ax4.tick_params(axis='y', labelcolor='green')

# ax4_twin = ax4.twinx()
# ax4_twin.plot(merged_sh['Year'], merged_sh['CO2'], color='red', label='CO2')
# ax4_twin.set_ylabel('CO2', color='red')
# ax4_twin.tick_params(axis='y', labelcolor='red')

# ax4.set_title('Southern Hemisphere\'s Sea Ice Extent and CO2 Emissions Over Time')
